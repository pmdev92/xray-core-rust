...
pub struct GeoIP {
    ...
    // @@protoc_insertion_point(field:GeoIP.reverse_match)
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                24 => {
                    self.reverse_match = is.read_bool()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\x0cR\x02ip\x12\x16\n\x06prefix\x18\x02\x20\x01(\rR\x06pref\
    ix\"j\n\x05GeoIP\x12!\n\x0ccountry_code\x18\x01\x20\x01(\tR\x0bcountryCo\
    de\x12\x19\n\x04cidr\x18\x02\x20\x03(\x0b2\x05.CIDRR\x04cidr\x12#\n\rrev\
    erse_match\x18\x03\x20\x01(\x08R\x0creverseMatch\")\n\tGeoIPList\x12\x1c\
    \n\x05entry\x18\x01\x20\x03(\x0b2\x06.GeoIPR\x05entry\"M\n\x07GeoSite\
    \x12!\n\x0ccountry_code\x18\x01\x20\x01(\tR\x0bcountryCode\x12\x1f\n\x06\
    domain\x18\x02\x20\x03(\x0b2\x07.DomainR\x06domain\"-\n\x0bGeoSiteList\
    \x12\x1e\n\x05entry\x18\x01\x20\x03(\x0b2\x08.GeoSiteR\x05entryb\x06prot\
    o3\
";
